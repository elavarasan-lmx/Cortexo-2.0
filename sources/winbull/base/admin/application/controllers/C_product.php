...
class C_product extends My_Controller {
	var $form_entry		= "product_entry";
	var $listing_form	= "product_listing";
	...
	function DB_Controller($model_name="",$status="",$id="")	//Control DB Process and Validation Process.
	{
		...
		{									 
			...
			redirect("/C_product/open_listingform/");		
		}
		else
		{		
	...
	function get_ajax_categorylist() {
		$model_name = $this->model_name;
		$this->load->model($this->model_name);
		echo $this->$model_name->get_ajax_categorylist();	
	}
	
	function get_ajax_comtypelist() {
		$model_name = $this->model_name;
		$this->load->model($this->model_name);
		echo $this->$model_name->get_ajax_comtypelist();	
	}
