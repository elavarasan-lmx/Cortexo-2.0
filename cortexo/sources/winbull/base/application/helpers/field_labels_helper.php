...
if (!function_exists('get_field_labels')) {
    ...
    function get_field_labels() {
        return array(
            ...
            'contract_tick' => 'Tick',
            'contract_time' => 'Time',
            'contract_commodity_id' => 'Commodity ID',
            ...
            'margin_reverse_type' => 'Display Limit order Page',
            ...
            'opening_date' => 'Qty(Gold in KG)',
            'gold_open_qty' => 'Date',
            'gold_open_rate' => 'Rate(Gold,1 Gram)',
            'silver_open_qty' => 'Qty(Silver in KG)',
            'silver_open_rate' => 'Rate(Silver,1 KG)',
...
if (!function_exists('get_field_value_labels')) {
    ...
    function get_field_value_labels() {
        return array(
            ...
            'confirmation_for' => array(0 => 'Rejection', 1 => 'Confirmation'),
            ...
            // Hedge Master value mappings
            'hm_commodity' => array(0 => 'GOLD', 1 => 'SILVER'),
            'hm_com_type' => array(0 => 'MEGA', 1 => 'MINI', 2 => 'MICRO'),
            'hm_hedgetype' => array(0 => 'Hedge', 1 => 'Mothilal Oswal'),
            'hm_roundoff_enabled' => array(1 => 'Active', 0 => 'Disabled'),
            'hm_hedgestatus' => array(1 => 'Active', 0 => 'Disabled'),
