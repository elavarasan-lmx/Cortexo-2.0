    ...
    <div class="content-wrapper">
		<div class="row">
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title" data-original-title=""><a href="<?php echo $this->config->item('base_url') ?>index.php/C_whatsapp_settings/open_listingform" class="btn btn-primary btn-sm add_new" role="button"><i class="typcn typcn-delete btn-icon-append"></i> Close</a> </h4>
						<?php
							$status			=	$type;
							$id				=	$_POST['fv']['service_id']==NULL ? NULL : $_POST['fv']['service_id'] ;	
							
							$attributes 	=	array('class' => 'iframeForm', 'id' => 'iframeForm', 'name' => 'iframeForm');
							echo form_open('C_whatsapp_settings/DB_Controller/Whatsapp_settings_model/'.$status.'/'.$id,$attributes); 
								
						?>	
						<form class="form-sample">
							<p class="card-description card-description1"> Whatsapp Settings</p>
								<?php 
							...
							<div class="row form-sample1">
								<div class="col-md-6">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label">Whatsapp Content*</label>
										<div class="col-sm-9">
											<textarea style="width: 100%;" class="form-control" rows="10" name="fv[whatsapp_content]" id="whatsapp_content" required minlength="10" maxlength="2000"><?php echo set_value('whatsapp_content',$whatsapp_content);?></textarea>
							...
							<div class="row form-sample1">
								<div class="col-md-6">
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input style="" class="form-control"  type="text" id="whatsapp_footer" name="fv[whatsapp_footer]" value="<?php echo set_value('whatsapp_footer',$whatsapp_footer);?>" maxlength="50" minlength="5" required data-validate="no-consecutive-dots" onkeydown="validateKeyPress(event, this,8)"/>
