<?php
class C_admininfo extends My_Controller {
	var $menu_code	= 35;
	var $form_entry = "C_admininfo_entry";	
	public function __construct()
	{
		parent::__construct();	
		$this->load->model("C_admininfo_model");
	...
	function open_listingform($db_error_msg="") {		
		...
		{
			$this->load->view('C_admininfo_listing', $data);
		}
		else
		{
	...
	{		
		...
		{									 
			...
			$data['error']="success";
			redirect("/C_admininfo/open_listingform/");																										   																						//Sending status to view as success.
		}
		else
		{		
