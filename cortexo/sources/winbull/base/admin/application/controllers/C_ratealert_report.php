<?php
class C_ratealert_report extends My_Controller {
	public function __construct()
	{
		parent::__construct();
		$this->load->model("ratealertreport_model");			
	}	
	function index() {
		
	}
	function open_listingform() {
		$this->load->view('ratealert_report');
	}
	// grid coding
	function grid_dataload($model_name = "", $from_date = "", $to_date = "") {
		//$this->header_content(); 	
		$this->load->model('ratealert_report_model');
        $req_param = array (
