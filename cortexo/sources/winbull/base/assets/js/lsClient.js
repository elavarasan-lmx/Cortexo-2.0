...
define(["LightstreamerClient"],function(LightstreamerClient) {
    ...
    //var lsClient = new LightstreamerClient(protocolToUse+"//logimaxrates.in:"+portToUse,"WLSTOCKLIST_REMOTE");
    var lsClient = new LightstreamerClient(lsdata.url,lsdata.adapter);
    lsClient.connectionOptions.setHttpExtraHeaders({"username" : lsdata.username});
